    ...
    <div class="grid-16">	
        <div class="widget widget-table">
            ...
            <div class="widget-content">
                ...
                <table class="table table-bordered table-striped data-table" id ="product_tbl">
                    <thead>
                        <tr>
                            <th>Id</th>
                            <th>Image</th>
                    ...
                    <tbody>
                        ...
                        foreach ($listNews as $news) {
                            ?>
                            <tr pid="<?php echo $news['id']; ?>">
                                <td><?php echo $news['id']; ?></td>
                                <td style="text-align: center;">
                                    <?php
                                    $srcImg = "";
                                    if (!empty($news['image_path']) && file_exists(PUBLIC_PATH . 'images/' . $news['image_path'])) {
                                        $srcImg = base_url() . 'public/images/' . $news['image_path'];
                                    } else {
...
<input id="mode" type="hidden" value="news"/>